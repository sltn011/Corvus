...
namespace Corvus
{
    ...
    POpenGLRenderBuffer::POpenGLRenderBuffer(UInt32 const Width, UInt32 const Height, GLenum const InternalFormat)
    {
    ...
    POpenGLRenderBuffer::POpenGLRenderBuffer(POpenGLRenderBuffer &&Rhs) noexcept : m_RBO{std::exchange(Rhs.m_RBO, 0)}
    {
    }
