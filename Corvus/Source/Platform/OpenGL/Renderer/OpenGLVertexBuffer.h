#ifndef CORVUS_SOURCE_PLATFORM_OPENGL_RENDERER_OPENGLVERTEXBUFFER_H
#define CORVUS_SOURCE_PLATFORM_OPENGL_RENDERER_OPENGLVERTEXBUFFER_H
...
namespace Corvus
{
    ...
    public:
        ...
        virtual void SetData(void const *Data, UInt32 NumVertices, CVertexBufferLayout const &Layout)
            override;
...
#endif // !CORVUS_SOURCE_PLATFORM_OPENGL_RENDERER_OPENGLVERTEXBUFFER_H
